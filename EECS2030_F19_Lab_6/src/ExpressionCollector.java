...
class ConjoinAll extends ExpressionCollector{	
}

class DisjoinAll extends ExpressionCollector{
	
}

class TimesAll extends ExpressionCollector{
	
}

class AddAll extends ExpressionCollector{
